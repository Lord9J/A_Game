...
onready var colorbutton_scene = preload("res://Planet_Generator/GUI/ColorPickerButton.tscn")


const GIFExporter = preload("res://Planet_Generator/addons/gdgifexporter/exporter.gd")
const MedianCutQuantization = preload("res://Planet_Generator/addons/gdgifexporter/quantization/median_cut.gd")
